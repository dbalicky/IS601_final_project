...
### Add e2e tests for hypotenuse operation in test_fastapi_calculator

**Add test for creating hypotenuse calculation with valid inputs**
```bash
...
**Add test for creating hypotenuse calculation with invalid inputs**
```bash
